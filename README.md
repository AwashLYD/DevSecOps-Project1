...
for Final Output Please refer to the linkedln profile
https://www.linkedin.com/posts/activity-7354524257084665857-Oviw?utm_source=share&utm_medium=member_desktop&rcm=ACoAACY74gkBUtwskDdA_IAvKNLeRaESUXIyFis
...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/AwashLYD/DevSecOps-Project1.git
    ```
...
pipeline{
    ...
    stages {
        ...
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 awash101/netflix:latest'
            }
        }
    }
}
